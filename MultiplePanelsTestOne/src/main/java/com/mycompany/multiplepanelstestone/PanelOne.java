...
public class PanelOne extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelOne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
